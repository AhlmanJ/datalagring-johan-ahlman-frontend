...
# Why use AI when you're still learning?
...
- Even though i have used AI to build the code for the frontend, i have still learned more about the frontend during this process because i had to read through and understand the code that the AI built.

# How do you use the frontend with backend?
...
NOTE! You must start the server and run the backend part on localhost:7253 if you want to test the frontend functions. ---> See my other repository for this assignment on GitHub named " datalagring-johan-ahlman ".
